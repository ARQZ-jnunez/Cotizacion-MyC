...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            ...
            <small>Encuentra y gestiona las solicitud de cotizaciones.</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fas fa-tachometer-alt"></i> Inicio</a></li>
            <li class="active">Solicitud de Cotizacion</li>
        </ol>
    </section>
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        ...
                        <div class="box-tools pull-right">
                            <a href="${pageContext.request.contextPath}/RequestPrice/Create" class="btn btn-box-tool"><i
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <table id="dataTableUsers" class="display" style="width:100%">
                                    ...
                                    <tbody>
                                        <c:forEach items="${listRequestPrice}" var="requestPrice">
                                            <tr>
                                                <td>${requestPrice.getId()}</td>
                                                <td>${user.getNames()}</td>
                                                <td>${user.getRut()}</td>
