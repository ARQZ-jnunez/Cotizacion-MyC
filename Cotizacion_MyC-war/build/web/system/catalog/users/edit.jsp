            ...
            <div class="col-sm-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Editar a Jose Nuñez</h3>
                    </div>
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="inputName"
                                       placeholder="Ingresa el nombre" value="Jose Nuñez">
                            </div>
                            <div class="form-group">
                                <label>RUT</label>
                                <input type="text" class="form-control" id="inputRut"
                                       placeholder="Ingresa el RUT" value="19134170-8">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group date" data-provide="datepicker">
                                    <input type="text" class="datepicker form-control" id="inputBorn"
                                           placeholder="dd/mm/yyyy" value="07/04/1995"
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="slctCargo" id="slctCargo">
                                        ...
                                        <option value="AL" selected>Administrador</option>
