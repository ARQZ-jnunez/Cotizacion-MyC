...
<script>
    $(document).ready(function () {
        ...
        $('#form').submit(function (ev) {
            ...
            if (!error) {
                toastr.success('Se ha creado el pack de servicios');
                setTimeout(function () {
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="slcServicio" id="slcServicio" multiple>
                                    <option value="">Mantencion Calderas</option>
                                    <option value="">Mantencion Gas</option>
                                    <option value="">Mantencion Agua</option>
                                    <option value="">Mantencion Tejado</option>
